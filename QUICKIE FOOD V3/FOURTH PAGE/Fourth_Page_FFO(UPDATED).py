...
class FFOApp:
    ...
    def load_images(self):
        self.background_image = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Desktop\QUICKIE FOOD V3\FOURTH PAGE\FourthWinBg.png"))
        self.back_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Desktop\QUICKIE FOOD V3\FOURTH PAGE\BackICON.png").resize((20, 20)))
        self.confirm_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Desktop\QUICKIE FOOD V3\FOURTH PAGE\ConfirmICON.png").resize((200, 50)))
        self.add_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Desktop\QUICKIE FOOD V3\FOURTH PAGE\AddICON.png").resize((30, 30)))
        self.minus_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Desktop\QUICKIE FOOD V3\FOURTH PAGE\MinusICON.png").resize((30, 30)))
