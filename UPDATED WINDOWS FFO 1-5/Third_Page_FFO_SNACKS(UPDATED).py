...
class FFOApp:
    ...
    def load_images(self):
        self.background_image = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Window_Bg_Snacks(3).png"))
        self.burger_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Burger_Button(3).png").resize((170, 170)))
        self.fries_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Fries_Button(3).png").resize((170, 170)))
        self.shawarma_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Shawarma_Button(3).png").resize((170, 170)))
        self.pizza_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Pizza_Button(3).png").resize((170, 170)))
        self.siomai_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Siomai_Button(3).png").resize((170, 170)))
