...
class FFOApp:
    ...
    def load_images(self):
        self.background_image = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Second Page.png"))
        self.snacks_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\SNACKS (2).png").resize((200, 169)))
        self.drinks_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Drinks (2).png").resize((200, 169)))
        self.menu_tab_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\tab for page 2.png").resize((60, 40)))
        self.cart_tab_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Cart.png").resize((60, 40)))
