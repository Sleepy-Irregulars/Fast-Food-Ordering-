...
class FFOApp:
    ...
    def load_images(self):
        self.background_image = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Desktop\FFO OOP\FirstWin_Bg.png"))
        self.dine_in_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Dine In.png").resize((200, 169)))
        self.take_out_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Desktop\FFO OOP\Take Out.png").resize((200, 169)))
