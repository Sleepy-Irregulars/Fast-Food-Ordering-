...
class FFOApp:
    ...
    def load_images(self):
        self.background_image = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Downloads\Picture1 (2).png"))
        self.confirm_img = ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Pictures\Icons ng FFO Window 4-5\Confirm_button(5).png").resize((250, 75)))
