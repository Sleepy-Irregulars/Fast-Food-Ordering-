...
SpriteImg=ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Pictures\Sprite_Button(3)UPDATED.png").resize((170,170)))
CokeFloatImg=ImageTk.PhotoImage(Image.open(r"C:\Users\Admin\Pictures\CokeFloat_Butto(3)UPDATED.png").resize((170,170)))
